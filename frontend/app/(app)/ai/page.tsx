    ...
    <div className="space-y-12 pb-16">
      ...
      <section aria-labelledby="ai-features-heading" className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Link
            href="/ai/playlist"
            className="group relative flex flex-col justify-between overflow-hidden rounded-3xl bg-gradient-to-br from-purple-950/40 via-neutral-900 to-neutral-900 p-8 border border-purple-800/30 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-950/40 transition-all duration-300 select-none"
          >
            <div className="space-y-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-purple-500/20 text-purple-300 border border-purple-500/30 group-hover:scale-110 group-hover:bg-purple-500 group-hover:text-black transition-all">
            ...
            <div className="mt-6 flex items-center gap-2 text-xs font-bold text-purple-400 group-hover:text-purple-300">
